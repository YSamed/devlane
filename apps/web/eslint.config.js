...
export default defineConfig([
  ...
  {
    // Vendored shadcn/ui components are generated by the shadcn CLI and kept
    // close to upstream so they stay re-generatable. Upstream colocates the
    // cva variant objects with the component, which trips the react-refresh
    // single-export rule — a dev-only HMR concern, not a correctness one.
