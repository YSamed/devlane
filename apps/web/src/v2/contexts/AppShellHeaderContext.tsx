 ...
 * `AppShell`'s header, which otherwise names the page from the URL alone.
 *
...
export function AppShellHeaderProvider({ children }: { children: ReactNode }) {
...
/** Read-side hook: used by the header in `AppShell`. */
export function useAppShellHeader(): V2HeaderState {
