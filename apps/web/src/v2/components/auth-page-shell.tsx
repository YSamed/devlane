...
/* Every v2 auth page renders inside this shell, so the v2 stylesheet rides
   along with their chunk instead of the app's global index.css. */
 ...
 *
 * Extracted from LoginPage/SignUpPage, which had this markup duplicated
