...
/**
 * The v2 view of a project's saved view, built from shadcn primitives. It
 * renders at the same URL as ViewDetailPage; the stored interface preference
 * picks between them.
 *
 ...
 * `AppShell`; the display provider recognises this tree's path as well as
 ...
 * with WorkspaceViewsPage — the two show the same records under the same
