...
/* One hue per state group, matching AnalyticsOverviewPage's ramp so a reader
...
/**
 * The v2 view of the work item analytics, built from shadcn primitives. It
 * renders at the same URL as AnalyticsWorkItemsPage; the stored interface
