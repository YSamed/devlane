...
import { SignUpForm, type SignUpStep } from '@/v2/components/signup-form';
import { isPasswordStrong } from '@/v2/components/password-field';
...
export function SignUpPage() {
  ...
  return (
    <AuthPageShellV2
      heroTitle1={t('auth.signUp.heroTitle1', 'Plan the work.')}
      heroTitle2={t('auth.signUp.heroTitle2', 'Ship the product.')}
      heroDescription={t(
