...
import { SettingsShell, type SettingsSectionGroup } from '@/v2/components/settings/settings-shell';
import { ApiTokensPanel } from '@/v2/components/settings/api-tokens-panel';
import { NotificationPreferencesPanel } from '@/v2/components/settings/notification-preferences-panel';
import { AccountActivityPanel } from '@/v2/components/settings/account/account-activity-panel';
import { AccountPreferencesPanel } from '@/v2/components/settings/account/account-preferences-panel';
import { AccountProfilePanel } from '@/v2/components/settings/account/account-profile-panel';
import { AccountSecurityPanel } from '@/v2/components/settings/account/account-security-panel';
import { ProjectAutomationsPanel } from '@/v2/components/settings/project/project-automations-panel';
import { ProjectFeaturesPanel } from '@/v2/components/settings/project/project-features-panel';
 ...
 */
export function SettingsPage({ scope }: SettingsPageV2Props) {
    ...
    scope === 'project'
      ...
      : [
          ...
          },
          {
            ...
            to: `/${workspaceSlug}/settings/projects`,
          },
        ];
  ...
  const picker =
    scope === 'projects' && projects.length > 0 ? (
      <Select
        ...
        onValueChange={(value) =>
          navigate(`/${workspaceSlug}/settings/projects/${value}?section=${section}`)
        }
      >
