...
import { DraftsToolbar } from '@/v2/components/drafts-toolbar';
...
/**
 * The v2 view of the workspace drafts page, built from shadcn primitives. It
 * renders at the same URL as DraftsPage; the stored interface preference picks
 * between them.
 *
