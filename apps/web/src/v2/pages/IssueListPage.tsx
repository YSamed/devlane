...
import { CreateWorkItemDialog } from '@/v2/components/create-work-item-dialog';
...
import {
  ...
  InlinePriorityCell,
  InlineStateCell,
} from '@/v2/components/work-item-inline-cells';
import { WorkItemActionsMenu, WorkItemContextMenu } from '@/v2/components/work-item-row-actions';
import { WorkItemsBulkBar } from '@/v2/components/work-items-bulk-bar';
import { WorkItemsDisplayMenu } from '@/v2/components/work-items-display-menu';
import { WorkItemsFiltersMenu } from '@/v2/components/work-items-filters-menu';
import { WorkItemsBoardLayout } from '@/v2/components/work-item-layouts/work-items-board-layout';
import { WorkItemsCalendarLayout } from '@/v2/components/work-item-layouts/work-items-calendar-layout';
...
export function IssueListPage() {
  ...
  const issueUrl = (issueId: string) => `/${workspaceSlug}/projects/${projectId}/issues/${issueId}`;
