...
/**
 * Design preview of a single cycle, built from shadcn primitives. It stands
 * alongside CycleDetailPage rather than replacing it, so the two can be
 ...
 */
export function CycleDetailPageV2() {
  ...
  const parent = useMemo(
    () => ({
      ...
      to: `/${workspaceSlug}/app-v2/projects/${projectId}/cycles`,
    }),
