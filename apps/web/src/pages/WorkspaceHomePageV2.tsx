...
/**
 * Design preview of the workspace home, built from shadcn primitives. It stands
 * alongside WorkspaceHomePage rather than replacing it, so the two can be
 ...
 * reason to re-derive.
 */
export function WorkspaceHomePageV2() {
  ...
  const recentHref = (visit: RecentVisitApiResponse): string | null => {
    ...
    if (visit.entity_name === 'issue' && visit.project_id) {
      return `/${workspaceSlug}/app-v2/projects/${visit.project_id}/work-items/${visit.entity_identifier}`;
    }
    if (visit.entity_name === 'project') {
      return `/${workspaceSlug}/app-v2/projects/${visit.entity_identifier}/work-items`;
    }
    if (visit.entity_name === 'page' && visit.project_id) {
      return `/${workspaceSlug}/app-v2/projects/${visit.project_id}/pages/${visit.entity_identifier}`;
    }
    return null;
  };
