...
/**
 * Search, project filter and the create action for the drafts page, built from
 * shadcn primitives.
 *
 * State lives in the URL rather than a context: the drafts page is the only
 * reader, and `?create=1` is already the shipped page's way of opening the
 * composer, so a deep link keeps working across both. It sits in the v2 shell's
 * header, mirroring how the shipped AppShell hangs per-page controls off it.
 */
export function DraftsToolbar({ workspaceSlug }: { workspaceSlug: string }) {
